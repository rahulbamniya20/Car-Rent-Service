                    ...
                    <Col lg='3' md='4' sm='6'>
                        <div className="mb-4">
                            ...
                            <p className="office__info">
                                101, Apollo Premier Building, Vijay Nagar Square, Indore Madhya Pradesh 452011
                            </p>
                            <p className="office__info">Phone: +91 1234567890</p>
                            <p className="office__info">E-mail: rahul78bamniya@gmail.com</p>
                    ...
                    <Col lg='12'>
                        <div className="footer__bottom">
                            <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                                <i class="ri-copyright-line"></i> Copyright {year}, Developed By Rahul Bamniya. All Rights Reserved.
                            </p>
                        </div>
                    </Col>
                </Row>
